...
extern interface IResourceManager implements flash.events.IEventDispatcher {
	...
	function loadResourceModule(url : String, ?update : Bool, ?applicationDomain : flash.system.ApplicationDomain, ?securityDomain : flash.system.SecurityDomain) : flash.events.IEventDispatcher;
