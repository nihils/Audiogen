...
class Audiogen
{
	...
	public function new() {
		...
		switch (content){
			case 1: syn = new Sawtooth(512, 25);
			case 2: syn = new SawtoothAliased(512);
			case 3: syn = new Square(512, 25);
			case 4: syn = new SquareAliased(512);
                        case 5: syn = new Triangle(512, 25);
                        case 6: syn = new TriangleAliased(512);
                        case 7: syn = new KarplusStrong(512);
			default: syn = new Sine(512);
		}
		snd = new Sound();
